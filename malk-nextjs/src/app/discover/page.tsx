...
const categories: Category[] = [
  ...
  { name: 'Film / TV / Movies', icon: FilmIcon, href: '/category/film' },
  { name: 'Beauty / Fashion', icon: SparklesIcon, href: '/category/fashion' },
  { name: 'Learning', icon: AcademicCapIcon, href: '/category/learning' },
  { name: 'Nature', icon: SunIcon, href: '/category/nature' },
  { name: 'Crafting / Tech', icon: CommandLineIcon, href: '/category/tech' },
